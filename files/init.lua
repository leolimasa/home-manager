...
vim.keymap.set('n', '<leader>sc', require('fzf-lua').grep_project, { desc = '[S]earch file [C]ontents' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<C-n>', vim.lsp.buf.signature_help, 'Signature Documentation')
